...
```{r echo=F}
va <- read_excel(here("Stata, R concordance/cleaned.xlsx"), sheet = "VoiceandAccountability")
...
```{r out.width="60%"}
include_graphics(here("Stata, R concordance/Voice and Accountability - R.png"))
```
]
]
...
```{r echo=F}
include_graphics(here("Stata, R concordance/Voice and Accountability - Stata.png"))
```
]
.pull-right[
